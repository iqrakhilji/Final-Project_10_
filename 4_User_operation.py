...
class UserOperations:
    ...
    def load_food_items(self):
            with open(r'C:\Users\iqra\Desktop\__20__final_project.py\FoodItems.json', 'r') as file:
                self.data= json.load(file)
    def write_food_items(self,data):
        with open(r'C:\Users\iqra\Desktop\__20__final_project.py\orderHistory.json','w') as addfile:
    ...
    def placeOrder(self):
       ...
       if not self.selected_items:
            ...
            with open(r'C:\Users\iqra\Desktop\__20__final_project.py\orderHistory.json','r') as file:
